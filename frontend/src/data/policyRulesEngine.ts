/**
 * FRONTEND MAHARASHTRA STATE POLICY & INCENTIVE RULES ENGINE
 * Ingests Official Government Resolutions (GRs):
 * 1. Maharashtra Industrial Policy 2019 / Package Scheme of Incentives (PSI 2019)
 * 2. Maharashtra Electric Vehicle Policy 2021
 * 3. Maharashtra Logistics Policy 2024
 * 4. Maharashtra Aerospace & Defence Manufacturing Policy 2018
 * 5. Maharashtra FinTech Policy 2018 & 2018 Addendum
 * 6. Maharashtra State Textile Policy 2018-23
 */
...
export function evaluatePolicyIncentives(input: EvaluationRequest): CalculatedIncentives {
  ...
  let scale: EnterpriseScale = "MICRO";

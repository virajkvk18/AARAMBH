        ...
        <div className="flex min-w-0 items-center justify-between h-16 sm:h-18">
          ...
          <Link href="/" className="flex min-w-0 items-center space-x-2 sm:space-x-3 group focus:outline-hidden">
            ...
            <div className="flex min-w-0 flex-col">
              ...
              <span className="truncate text-[11px] font-medium text-slate-500 tracking-normal">
...
<div className="flex sm:hidden items-center space-x-1 shrink-0">
  ...
  {user && (
    <Link
      ...
      className="min-h-10 px-2.5 py-1.5 rounded-lg bg-[#FE7251] text-white text-xs font-semibold flex items-center gap-1.5 whitespace-nowrap"
      title="Go to your business control center"
    >
      <Briefcase className="w-3.5 h-3.5" />
      <span className="hidden min-[375px]:inline">
        {t("my_business", "MY BUSINESS")}
      </span>
    </Link>
  )}
</div>

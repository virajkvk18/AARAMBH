// test-email-otp.js — Real Supabase Email OTP integration test
// Reads endpoint + keys from .env (gitignored).
// Usage: node test-email-otp.js <email> [<6-digit-code>]
...
async function run() {
  if (!TEST_EMAIL) {
    console.error("Usage: node test-email-otp.js <email> [<6-digit-code>]");
    process.exit(1);
  }
  ...
  if (OTP_CODE) {
    console.log(`\n=== TEST 6: verifyOtp with actual code ${OTP_CODE} ===`);
    ...
    console.log(`  node test-email-otp.js ${TEST_EMAIL} <code>`);
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  }
}
